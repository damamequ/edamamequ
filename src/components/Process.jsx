export default function Process({ data }) {
    ...
    return (
        <section className="min-h-screen flex items-center py-24 bg-white" id="process">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
                        {data.steps?.map((step, i) => (
                            <div key={i} className="text-center group">
                                <div className="size-24 rounded-full bg-white border-2 border-[var(--color-primary)]/20 flex items-center justify-center mx-auto mb-8 group-hover:bg-[var(--color-primary)] group-hover:border-[var(--color-primary)] transition-all shadow-lg">
