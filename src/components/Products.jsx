    ...
    return (
        <section className="min-h-screen flex items-center py-24 bg-[#e8f5e9]" id="products">
            <div className="max-w-7xl mx-auto px-6 w-full">
                ...
                <div className="mt-16 text-center bg-white p-8 md:p-12 rounded-[2rem] border border-[var(--color-primary)]/10 shadow-sm">
                    ...
                    <a
                        className="inline-flex items-center gap-3 px-10 py-4 bg-[#25D366] text-white font-bold rounded-xl shadow-xl hover:scale-[1.02] transition-transform"
